...
const navigation = [
  { name: "Retailers", href: "#features" },
  { name: "Services", href: "#ai-team" },
  { name: "Manufacturers", href: "#testimonials" },
  { name: "Workshops & Studios", href: "/car-dealerships" },
]
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center">
                  <Image
                    src="/images/Logo/BadgeWhite.png"
                    alt="Nexablend"
                    width={40}
                    height={40}
              ...
              <div className="hidden md:block">
                ...
                >
                  <span className="mr-2">Join Waitinglist</span>
