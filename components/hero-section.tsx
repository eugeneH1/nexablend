    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-medium mb-8 mt-12 animate-fade-in-badge">
          ...
          Simple software to run your South African business.
        </div>
        ...
        Nexablend gives South African businesses the essential tools to run better—from POS and inventory to bookings and CRM—with zero fluff and total control. 
        </p>
        ...
        <div className="text-center px-4 hidden sm:block overflow-hidden animate-fade-in-trust">
          <p className="text-sm text-white mb-6">Trusted by innovative South African companies</p>
          <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
            <div className="flex items-center gap-8 opacity-60 hover:opacity-80 transition-all duration-500 animate-slide-left">
              <div className="flex items-center gap-8 whitespace-nowrap">
                <div className="text-base sm:text-lg font-semibold">Solar and Backup Installers</div>
                <div className="text-base sm:text-lg font-semibold">Auto & Panel Workshops</div>
                <div className="text-base sm:text-lg font-semibold">Tech & Cell Repair Centres</div>
                <div className="text-base sm:text-lg font-semibold">Pet Grooming & Day Care Centres</div>
                <div className="text-base sm:text-lg font-semibold">Medical Practices</div>
                <div className="text-base sm:text-lg font-semibold">Fitness Centres</div>
                <div className="text-base sm:text-lg font-semibold">Insurance Brokers</div>
              </div>
              {/* Duplicate for seamless loop */}
              <div className="flex items-center gap-8 whitespace-nowrap">
                <div className="text-base sm:text-lg font-semibold">Real Estate Agencies</div>
                <div className="text-base sm:text-lg font-semibold">Law Firms</div>
                <div className="text-base sm:text-lg font-semibold">Pharmacies</div>
                <div className="text-base sm:text-lg font-semibold">Health Shops</div>
                <div className="text-base sm:text-lg font-semibold">Vape & Cannabis Stores</div>
                <div className="text-base sm:text-lg font-semibold">Furniture & Decor Makers</div>
                <div className="text-base sm:text-lg font-semibold">Craft Breweries</div>
              </div>
            </div>
          </div>
        </div>
