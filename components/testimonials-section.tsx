...
export function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      text: "We spend so much less time thinking about lead response because of the instant engagement Nexablend offers us.",
      name: "Sarah Chen",
      role: "Sales Manager",
    },
    {
      text: "With Nexablend, our conversion rates increased by 85% and boosted our weekend revenue by 40%.",
      name: "Michael Torres",
    ...
    {
      text: "Customer satisfaction scores improved dramatically since implementing Nexablend. Clients love the instant responses and personalized recommendations.",
      name: "David Kim",
    ...
    {
      text: "Property inquiries are handled instantly now. We've closed 3x more deals since implementing Nexablend's AI assistant.",
      name: "James Wilson",
