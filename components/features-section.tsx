...
const features = [
  ...
  },
  {
    ...
    description:
      "Professional WhatsApp built into your website that books appointments when you're busy or closed.",
  ...
  },
  {
    ...
    description:
      "Automatic email assistant that responds to inquiries, provides information, and forwards complex queries to your team.",
  ...
  },
  {
    ...
    description:
      "Connect with your existing tools including Google Calendar, WhatsApp, SMS, and email for a unified customer experience.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              Watch our software handle real customer interactions around the clock,
